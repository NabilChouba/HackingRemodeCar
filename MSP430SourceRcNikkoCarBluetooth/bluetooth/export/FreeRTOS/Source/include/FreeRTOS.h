...
#define INCLUDE_xTaskGetSchedulerState 0
     ...
     * within the mutex implementation so must be available if mutexes are
     * used. */
...
#define traceTASK_SWITCHED_OUT()
     ...
     * queue/mutex/semaphore.  pxQueue is a pointer to the
     * queue/mutex/semaphore upon which the read was attempted.  pxCurrentTCB
     * points to the TCB of the task that attempted the read. */
#define traceBLOCKING_ON_QUEUE_RECEIVE( pxQueue )
     ...
     * queue/mutex/semaphore.  pxQueue is a pointer to the
     * queue/mutex/semaphore upon which the write was attempted.  pxCurrentTCB
     * points to the TCB of the task that attempted the write. */
