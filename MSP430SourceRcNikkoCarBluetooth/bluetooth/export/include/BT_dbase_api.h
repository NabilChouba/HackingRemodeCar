...
enum db_profile_types {
    DB_SDP_SERVER = 0,
    DB_GENERIC_ACCESS = 1,
    DB_SERIAL_PORT = 2,
    DB_LAN_ACCESS = 3,
    DB_DIALUP_NETWORKING,
    DB_IRMCSYNC,
    DB_OBEX_PUSH,
    DB_OBEX_FILETRANSFER,
    DB_IRMCSYNC_COMMAND,
    DB_HEADSET,
    DB_CORDLESS_TELEPHONY,
    DB_INTERCOM,
    DB_FAX,
    DB_HEADSET_AUDIO_GATEWAY,
    DB_GENERIC_OBEX = 14,
    DB_SERVICE_DISCOVERY_APP = 15,
    DB_BROWSEGROUP_DESC = 16,
    /* Printer Profile */
    DB_BPP_PRINTER_SERVICE = 17,
    DB_BPP_REF_OBJECTS_SERVICE = 18,
    DB_BPP_PRINTER_ADMIN_UI_SERVICE = 19,
    /* PAN Profile */
    DB_NETWORK_ACCESS_POINT = 20,
    DB_GROUP_NETWORK = 21,
    DB_PANU_SERVICE = 22,
    /* HCRP Profile */
    DB_HCRP_CNTL_DATA_SERVICE = 23,
    DB_HCRP_NOTIFY_SERVICE = 24,
    /* HID Profile */
    DB_HID_SERVICE = 25,
    /* HFP - HFU Profile */
    DB_HFP_HFU_SERVICE = 26,
    /* HFP - AG Profile */
    DB_HFP_AG_SERVICE = 27,
    /* AV - Advanced Audio Distribution Profile */
    DB_A2DP_SOURCE_SERVICE = 28,
    DB_A2DP_SINK_SERVICE = 29,
    /* PnP Information Record */
    DB_PNP_INFO_RECORD = 30,
    /* PBAP Profile */
    DB_PBAP_PCE = 35,
    DB_PBAP_PSE = 36
};
...
extern "C" {
    ...
    API_RESULT BT_dbase_get_rec_handles(UCHAR * /* uuids_array */ ,
                                        UCHAR /* num_uuids */ ,
                                        UCHAR * /* num_handles */ ,
                                        UINT32 *    /* han_array */
        );

    API_RESULT BT_dbase_get_attr_value(UINT32 /* record_handle */ ,
                                       UINT16 * /* attr_id */ ,
    ...
    API_RESULT BT_dbase_update_seravail(UINT32 /* rec_handle */ ,
                                        UCHAR   /* attr_val */
        );

    API_RESULT BT_dbase_update_attr_value(UINT32 /* record_handle */ ,
                                          UINT16 /* attr_id */ ,
                                          UCHAR * /* attr_value */ ,
                                          UINT16    /* attr_value_length */
        );

    API_RESULT BT_dbase_change_attr_value(UINT32 /* record_handle */ ,
                                          UINT16 /* attr_id */ ,
                                          UCHAR * /* attr_value */ ,
                                          UINT16    /* attr_value_length */
        );
    ...
    API_RESULT BT_dbase_activate_record(IN UINT32 record_handle);

    API_RESULT BT_dbase_inactivate_record(IN UINT32 record_handle);

    API_RESULT BT_dbase_get_record_handle(IN UCHAR service_type,
                                          IN UCHAR service_instance,
                                          OUT UINT32 * rec_hdl);

    API_RESULT BT_dbase_get_server_channel(IN UINT32 record_handle,
                                           IN UINT16 attr_id,
                                           OUT UCHAR * server_channel);

    API_RESULT BT_dbase_get_num_service_class_uuids(OUT UINT32 *
                                                    num_service_class_uuids);

    API_RESULT BT_dbase_get_service_class_uuids(OUT UCHAR * uuid_buffer,
                                                INOUT UINT32 *
                                                uuid_buffer_length);
